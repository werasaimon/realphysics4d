...
#SOURCES  += src/engine/physics-engine/Collision/BroadPhase/rbBroadPhaseAlgorithm.cpp
#SOURCES  += src/engine/physics-engine/Collision/BroadPhase/rpDynamicAABBTree.cpp
#SOURCES  += src/engine/physics-engine/Collision/Manifold/rpContactManifold.cpp
#SOURCES  += src/engine/physics-engine/Collision/Manifold/rpContactManifoldSet.cpp
#SOURCES  += src/engine/physics-engine/Collision/Manifold/rpContactPoint.cpp
#SOURCES  += src/engine/physics-engine/Collision/Manifold/rpGenerationContactManiflodSet.cpp
#SOURCES  += src/engine/physics-engine/Collision/NarrowPhase/GJK_EPA/rpGjkEpa.cpp
#SOURCES  += src/engine/physics-engine/Collision/NarrowPhase/rpNarrowPhaseCollisionAlgorithm.cpp
#SOURCES  += src/engine/physics-engine/Collision/Shapes/rpAABB.cpp
#SOURCES  += src/engine/physics-engine/Collision/Shapes/rpBoxShape.cpp
...
#SOURCES  += src/engine/physics-engine/Body/rpRigidPhysicsBody.cpp
#SOURCES  += src/engine/physics-engine/Collision/rpContactManager.cpp
#SOURCES  += src/engine/physics-engine/Dynamics/rpIsland.cpp
#SOURCES  += src/engine/physics-engine/Memory/MemoryAllocator.cpp
#SOURCES  += src/engine/physics-engine/Dynamics/Solver/rpContactSolverSequentialImpulseObject.cpp
#SOURCES  += src/engine/physics-engine/Geometry/QuickClipping/rpQuickClippingPolygons.cpp
...
SOURCES  += src/engine/physics-engine/Dynamics/Solver/rpContactSolverSequentialImpulseObject.cpp
SOURCES  += src/engine/physics-engine/Geometry/QuickClipping/rpQuickClippingPolygons.cpp
SOURCES  += src/engine/physics-engine/Memory/SmartAllocator.cpp
SOURCES  += src/engine/physics-engine/Collision/rpCollisionManager.cpp
SOURCES  += src/engine/physics-engine/Collision/Manifold/rpContactGeneration.cpp
