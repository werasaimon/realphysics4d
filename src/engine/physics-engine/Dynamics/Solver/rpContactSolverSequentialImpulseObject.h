...
// Return true if the split impulses position correction technique is used for contacts
SIMD_INLINE  bool rpContactSolverSequentialImpulseObject::isSplitImpulseActive() const
{
    return mIsSplitImpulseActive;
}

// Activate or Deactivate the split impulses for contacts
SIMD_INLINE  void rpContactSolverSequentialImpulseObject::setIsSplitImpulseActive(bool isActive)
{
