/*
 * rpAlignedobjectarray.h
 *
 *  Created on: 21 нояб. 2016 г.
 *      Author: wera
 */

#ifndef SOURCE_ENGIE_MEMORY_RPALIGNEDOBJECTARRAY_H_
#define SOURCE_ENGIE_MEMORY_RPALIGNEDOBJECTARRAY_H_
	...
	b3AlignedObjectArray()
{
			...
			SIMD_FORCE_INLINE	void	clear()
	{
			...
			SIMD_FORCE_INLINE  T  *data() const
			{
				return  &m_data[0];
			}
...
#endif /* SOURCE_ENGIE_MEMORY_RPALIGNEDOBJECTARRAY_H_ */
