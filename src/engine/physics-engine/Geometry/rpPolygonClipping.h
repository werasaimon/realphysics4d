...
#ifndef SOURCE_ENGIE_GEOMETRY_RPPOLYGONCLIPPING_H_
#define SOURCE_ENGIE_GEOMETRY_RPPOLYGONCLIPPING_H_
...
class rpPolygonClipping
{
  ...
  private:
	 ...
	 b3AlignedObjectArray<Vector3> mOutVertices;
	 //*************************************************************//


	 /// Private copy-constructor
	 rpPolygonClipping(const rpPolygonClipping& clipping);

	 /// Private assignment operator
	 rpPolygonClipping& operator=(const rpPolygonClipping& clipping);


  public:

	 rpPolygonClipping(const Vector3*  PolygonVertices , int  CountPolygonVertices ,
	...
	const Vector3* getDataVertices() const
	{
		return mOutVertices.data();
	}
	...
	const b3AlignedObjectArray<Vector3>& getOutVertices() const
	{
		return mOutVertices;
	}
...
#endif /* SOURCE_ENGIE_GEOMETRY_RPPOLYGONCLIPPING_H_ */
