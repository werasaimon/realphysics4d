...
struct bRGB
{
	unsigned char  rgbtRed; // Red component
	unsigned char  rgbtGreen; // Green component
	unsigned char  rgbtBlue; // Blue component
};
...
private :
	...
	// Read a JPEG picture
	static void readBMPPicture(const std::string& filename,
			Texture2D& textureToCreate) throw(std::runtime_error);
