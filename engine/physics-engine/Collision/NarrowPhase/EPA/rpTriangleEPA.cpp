...
bool TriangleEPA::computeClosestPoint(const Vector3* vertices)
{
    ...
    scalar v1Dotv1 = v1.dot(v1);
    scalar v1Dotv2 = v1.dot(v2);
    scalar v2Dotv2 = v2.dot(v2);
    scalar p0Dotv1 = p0.dot(v1);
    scalar p0Dotv2 = p0.dot(v2);
    ...
    if (mDet > 0.0)
    {
        ...
        mClosestPoint = p0 + scalar(1.0) / mDet * (mLambda1 * v1 + mLambda2 * v2);
