...
namespace real_physics
{
    class rpMPR
    {
      public:
        ...
        static void supportTransformed(const rpCollisionShapeInfo *s, const Vector3 &dir, Vector3 &result)
        {
        ...
        static bool ComputeMprColliderPenetration( const rpCollisionShapeInfo *s1, const rpCollisionShapeInfo *s2, OutContactInfo& out )
        {

            scalar collideEpsilon2 = 0.001f;
            int maxIterations2 = 40;
            ...
            if (v0.isZero())
                v0 = Vector3(collideEpsilon2, 0.0f, 0.0f);
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (delta <= collideEpsilon2 || penetration <= 0.0f || phase2 > maxIterations2)
                    {
