...
#ifndef SOURCE_ENGIE_COLLISION_NARROWPHASE_GJK_RPSIMPLEX_H_
#define SOURCE_ENGIE_COLLISION_NARROWPHASE_GJK_RPSIMPLEX_H_
...
#endif /* SOURCE_ENGIE_COLLISION_NARROWPHASE_GJK_RPSIMPLEX_H_ */
